...
namespace Firebase.Sample.Auth {
  ...
  using UnityEngine.UI;
    ...
    //InputFields for Authentication
    public InputField suEmail,suPassword,suUsername;
    public InputField siEmail, siPassword;
    public Text profileName;
        public UnityEvent AuthCompleted;
